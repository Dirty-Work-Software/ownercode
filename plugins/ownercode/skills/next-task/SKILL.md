...
2. Otherwise list `tasks/*.md`, read each file's frontmatter, keep `status: pending`.
...
6. Ask with the question tool (or, if it is missing, as a numbered list in your reply): start this task, pick a different one, or stop.
